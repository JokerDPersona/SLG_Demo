...
public class Packager {
    ...
    {
        AddBuildMap("testview" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Resources/Builds/TestView");


        AddBuildMap("testview_asset" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Resources/Textures/TestView");
    }
